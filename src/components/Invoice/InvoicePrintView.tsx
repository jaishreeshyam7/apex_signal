  ...
  return (
    <div className="fixed inset-0 z-50 bg-black/70 backdrop-blur-sm flex items-center justify-center p-2 sm:p-4 overflow-y-auto">
      ...
      <div className="bg-slate-100 rounded-2xl shadow-2xl max-w-4xl w-full my-auto overflow-hidden flex flex-col max-h-[96vh]">
        ...
        <div className="bg-[#0a152e] text-white px-6 py-4 flex items-center justify-between no-print shrink-0">
              ...
              {(['ORIGINAL FOR RECIPIENT', 'DUPLICATE FOR TRANSPORTER', 'TRIPLICATE FOR SUPPLIER'] as const).map((type) => (
                <button
                  ...
                  className={`px-2.5 py-1 rounded-md transition ${
                    copyType === type ? 'bg-blue-600 text-white' : 'text-slate-400 hover:text-white'
                  }`}
                >
                  {type.split(' ')[0]}
                </button>
          ...
          <div className="flex items-center gap-2">
            <button
              onClick={handlePrint}
              className="flex items-center gap-2 px-4 py-2 bg-blue-600 hover:bg-blue-700 text-white text-sm font-semibold rounded-lg shadow-md transition"
            >
        ...
        <div className="p-4 sm:p-8 overflow-y-auto bg-slate-200/60 flex-1 flex justify-center">
          <div className="bg-white text-black p-6 sm:p-8 w-full max-w-[800px] border border-black text-[12px] leading-tight font-sans shadow-lg print:border-none print:shadow-none print:m-0 print:p-0 print:max-w-none print:w-full invoice-print-sheet">
            ...
            <div className="text-center border-b border-black pb-1 mb-0">
              ...
              <p className="text-[10px] font-semibold text-slate-700">({copyType})</p>
            </div>
